...
export default function Home() {
  return (
    <div className="font-body flex flex-col justify-center items-center border h-screen w-screen">
      ...
      <div className="text-7xl">Lorem</div>
      <div className="text-center text-2xl text-gray-700 col mt-10">
        Lorem ipsum dolor, sit amet consectetur adipisicing elit. Eos,
        architecto nisi. Maiores quod facilis laboriosam repellendus
      </div>
      <Link to="/signup">
        <button
          type="button"
          className="text-xl mt-8 text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"
        >
          Get Started
        </button>
      </Link>
